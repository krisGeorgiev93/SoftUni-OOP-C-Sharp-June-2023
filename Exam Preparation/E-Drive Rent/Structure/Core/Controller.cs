namespace EDriveRent.Core
{
    ...
    public class Controller : IController
    {
        ...
        {
            //Route’s constructor will be expecting as the last parameter routeId.
            //So it should be created by taking the count of already added routes in the RouteRepository + 1.
